...
// Cảnh báo người chơi trước khi rời trang giữa lúc ván CARO đang diễn ra.
// Bản sao của hooks/useLeaveGameWarning.ts nhưng gắn với store cờ tướng.
// Gọi hook này 1 LẦN DUY NHẤT ở component cha (GomokuGame).
...
export function useGomokuLeaveWarning() {

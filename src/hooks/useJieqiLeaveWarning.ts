...
// Cảnh báo người chơi trước khi rời trang giữa lúc ván CỜ ÚP đang diễn ra.
// Bản sao của hooks/useLeaveGameWarning.ts nhưng gắn với store cờ tướng.
// Gọi hook này 1 LẦN DUY NHẤT ở component cha (JieqiGame).
...
export function useJieqiLeaveWarning() {

...
//
// Đặt biến môi trường XIANGQI_ENGINE_API_BASE trong file .env.local nếu endpoint
// thật của bạn khác với giá trị mặc định bên dưới, ví dụ:
//   XIANGQI_ENGINE_API_BASE=https://chessone.net/api/xiq

const ENGINE_API_BASE = process.env.XIANGQI_ENGINE_API_BASE || 'https://chessone.net/api/xiq'

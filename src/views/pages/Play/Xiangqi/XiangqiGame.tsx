...
// Component "nhạc trưởng" của ván cờ tướng - gộp toàn bộ các mảnh lại thành 1
...
import { useXiangqiSounds } from '@/hooks/useXiangqiSounds'
import { useXiangqiStore } from '@/stores/xiangqi'
import { useXiangqiLeaveWarning } from '@/hooks/useXiangqiLeaveWarning'
